...
public:
	...
	s_force getForce(int frame_cnt, int start_frame=0, double Ang=0.174533, double Fmag=0.6, int center_i=-4, int center_j=30, double R=10.0);//Fmag was originally 1
