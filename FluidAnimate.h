...
public:
	...
	void setForceActive(bool isActive) { m_vars.active = isActive; }
	...
	void setDyeActive(bool isActive) { m_dye.active = isActive; }

	void setSlidingWallActive(bool isActive = true) { m_sliding_wall.active= isActive; }
	bool slidingWallActive() { return m_sliding_wall.active; }
	s_force getSlidingWallU() { return m_sliding_wall; }
private:
	int m_grid_width;
	int m_grid_height;
